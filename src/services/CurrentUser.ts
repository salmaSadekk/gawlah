...
export class CurrentUser {
    ...
    private favTours:Tours[] =[new Tours('','','Accessories','Egyptian Museum','../../assets/imgs/UserProfile.png' ,'../../assets/imgs/egyptian Museum.png','17min','5',this.items,[ new Review(new User ('','Salma','',[] ,[],['English','French','German'],20 ) ,'1d ago','An amazing Tour',4)],0) ,
    new Tours('','','Sports','Egyptian Museum','../../assets/imgs/UserProfile.png' ,'../../assets/imgs/egyMuse.jpg','17min','5.5',[new Items('','statue','../../assets/imgs/status.jpg','Retrieved data from data base','Sports related info ','audio','video',2,2 ,'2')],[new Review(new User ('','Salma','',[] ,[],['English','French','German'],20 ) ,'1d ago','An amazing Tour',4)],7)] ;
